...
export class UserComponent implements OnInit {
  ...
  public config: any;
  user={email:'',nom:'',prenom:'',password:'',num_passport:'',age:0,cin:'',
  sexe:'',date_naissance:'',ville:null,gouvernorat_adresse:null,gouvern_naissance:null,id_situation_professionnel:null,pays:null,rue:'',code_postale:'',id_role:1};
